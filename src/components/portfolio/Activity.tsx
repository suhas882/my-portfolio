...
const stats = [
  { icon: FolderGit2, label: "Total Projects", value: "12+", color: "from-neon-blue/30 to-neon-blue/5" },
  { icon: Github, label: "GitHub Repos", value: "20+", color: "from-neon-purple/30 to-neon-purple/5" },
